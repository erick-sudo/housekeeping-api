...
from .views import RegisterUserView, VerifyUserEmailView, LoginUserView, TestAuthenticationView, PasswordResetRequestView, PasswordResetConfirmView, SetNewPasswordView, LogoutUserView

urlpatterns = [
    path('register', RegisterUserView.as_view(), name='register'),
    path('verify-email', VerifyUserEmailView.as_view(), name='verify'),
    path('login', LoginUserView.as_view(), name='login'),
    path('profile', TestAuthenticationView.as_view(), name='register'),
